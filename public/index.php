    ...
    <section>
        ...
        <div class="d-flex justify-content-around">
            <div class="card" style="width: 18rem;">
                <a href="annonce123.html" class="btn">
        ...
        <div class="d-flex justify-content-around">
            <div class="card" style="width: 18rem;">
                <a href="annonce4.html" class="btn">
            ...
            <div class="card" style="width: 18rem;">
                <a href="annonce5.html" class="btn">
            ...
            <div class="card" style="width: 18rem;">
                <a href="annonce6.html" class="btn">
        ...
        <div class="d-flex justify-content-around">
            <div class="card" style="width: 18rem;">
                <a href="annonce789.html" class="btn">
